...
UIText::UIText(const Vector2f& _position, const Color& _color, const string& _textValue, const int _textSize, const string& _fontPath, int* _additionalValue) : UIElement(_position)
{
