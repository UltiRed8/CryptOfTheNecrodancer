...
void MenuManager::InitMenuPause()
{
	...
	function<void()> _callbackDelete = [this]() {}; //TODO
...
void MenuManager::InitMenuOptions()
{
	...
	new Menu("Options", { new UIImage(Vector2f(0.f,0.f), Vector2f((float)window->getSize().x, (float)window->getSize().y), "OptionsMenu.png"),
		...
		}, "", _activateSound, FloatRect(static_cast<float>(window->getSize().x / 1.45), static_cast<float>(window->getSize().y / 2.8), 30.0f, 30.0f)),
		...
		}, "", _activateMusic, FloatRect(static_cast<float>(window->getSize().x / 1.45), static_cast<float>(window->getSize().y / 1.75), 30.0f, 30.0f)),
...
void MenuManager::InitGraphicMenu()
{
	...
	new Menu("Graphics", { new UIImage(Vector2f(0.f,0.f), Vector2f((float)window->getSize().x, (float)window->getSize().y), "GraphicsMenu.png"),
		...
		}, "", _fullscreen, FloatRect(static_cast<float>(window->getSize().x / 1.6), static_cast<float>(window->getSize().y / 3.3), 30.0f, 30.0f)),
